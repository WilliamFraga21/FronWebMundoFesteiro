...
<template>
  ...
  <div style="min-height: 1200px">
    ...
    <div class="container-fluid d-flex justify-content-between" style="width: 90%;margin-top: 40px">
      <div class="d-flex align-self-start" >
        <input type="text" name="cupom" id="cupom" placeholder="Código do Cupom" class="rounded form-control w-50">
